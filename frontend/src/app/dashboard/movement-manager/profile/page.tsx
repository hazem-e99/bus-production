...
import { toProxiedBackendAssetUrl } from '@/lib/backend-url';
...
export default function MovementManagerProfilePage() {
  ...
  const buildImageUrl = (imagePath: string | undefined): string => {
    ...
    return toProxiedBackendAssetUrl(imagePath);
  };
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div className="flex items-center gap-6">
              <div className="relative w-20 h-20 rounded-full overflow-hidden border-4 border-white shadow-lg bg-gradient-to-br from-orange-500 to-orange-600">
                {getAvatarDisplay()}
              </div>
              <div>
